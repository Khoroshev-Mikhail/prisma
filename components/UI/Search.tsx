...
export default function Search({ data, state, setState,  placeholder, isLoading, autofocus }){
    ...
    return (
        <div className='w-full'>
            ...
            <TextInput ref={ref} type="number" inputMode="numeric" className='w-full bg-white' value={state} id="search-mrp" onChange={setSearch} autoFocus autoComplete='off' placeholder={placeholder}/>
            {visible && 
